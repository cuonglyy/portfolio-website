...
const Skills = () => {
  return (
    ...
    >
      ...
      >
        <GridItem>
          <Box border="1px solid" borderRadius="6px" py={5}>
            <Box mb={4} px={5} borderBottom="1px solid">
              <Heading fontSize="24px">Frontend</Heading>
            </Box>
            <List spacing={4}>
        ...
        <GridItem>
          <Box border="1px solid" borderRadius="6px" py={5}>
            <Box mb={4} px={5} borderBottom="1px solid">
              <Heading fontSize="24px">Backend</Heading>
            </Box>
            <List spacing={4}>
              <ListItem fontSize="lg">
        ...
        >
          <Box border="1px solid" borderRadius="6px" py={5}>
            <Box mb={4} px={5} borderBottom="1px solid">
              <Heading fontSize="24px">Tools & Technologies</Heading>
            </Box>
            <List spacing={4}>
              <ListItem fontSize="lg">
                <ListIcon
